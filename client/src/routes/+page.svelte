...
<div class="mx-auto max-w-3xl space-y-6">
	<section class="rounded border border-zinc-300 bg-white">
		<header class="border-b border-zinc-300 px-4 py-3">
			<h2 class="text-sm font-semibold text-zinc-900">New evaluation</h2>
		...
		>
			<div>
				<label class="block text-sm font-medium text-zinc-800" for="project-name">
			...
			<div>
				<label class="block text-sm font-medium text-zinc-800" for="raw-input">Project material</label>
				<textarea
					id="raw-input"
					class="mt-1 h-40 w-full rounded border border-zinc-400 px-3 py-2 font-mono text-sm focus:border-zinc-900 focus:outline-none"
					bind:value={rawInput}
	...
	<section class="space-y-3">
		<h2 class="text-sm font-semibold text-zinc-900">Sessions</h2>
		{#if loaded}
